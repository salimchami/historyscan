...
/**
 * This annotation is used to mark a class as a SPI (Service Provider Interface) of the hexagonal architecture.
 * <p>
 * The hexagonal architecture is a way to structure your codebase in a way that the business logic is decoupled
 * from the technical details. This is done by defining a core domain (the business logic) and a set of ports
