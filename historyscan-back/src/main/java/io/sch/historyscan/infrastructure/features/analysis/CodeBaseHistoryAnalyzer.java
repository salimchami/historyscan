...
import io.sch.historyscan.infrastructure.features.analysis.git.CodebaseCurrentFiles;
...
//            git.pull().call();
            ...
            return new CodebaseCurrentFiles(codebaseCurrentFiles, git, repository).toCodebaseHistoryFrom();
        } catch (IOException e) {
