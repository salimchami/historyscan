...
public class FinallyLoading {
    ...
    public FinallyLoading(String analysisMapper, Long codebaseToAnalyzeMapper, Integer analyzeCodebaseHistory, BigDecimal analyzeCodebaseClocRevisions) {
